...
class AlbumList extends Component {
  ...
  componentWillMount() {
    axios.get('https://api.flickr.com/services/rest/?method=flickr.photosets.getList&api_key=6e8a597cb502b7b95dbd46a46e25db8d&user_id=42990025@N06&format=json&nojsoncallback=1')
